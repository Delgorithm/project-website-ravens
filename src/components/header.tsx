...
export default function Header({ setActiveMenu }) {
  ...
  const splitText = (text: string) =>
    text.split("").map((char, index) => (
      <li
        key={index}
        className="letter inline-block tracking-tighter"
  ...
  return (
    <div
      ref={container}
      className="absolute top-0 left-0 z-20 w-full h-screen text-[#E5E5E5] flex justify-center items-center pointer-events-auto"
    >
      <div className="leading-[14rem] relative w-[90%] select-none">
